...
class Adapter extends AbstractAdapter
{
    ...
    protected $publicUrl = 'https://f002.backblazeb2.com';

    public function __construct(Client $client, $bucketName, $bucketId = null, $url = null)
    {
        $this->client = $client;
    ...
    public function getUrl($path) {
        return "{$this->publicUrl}/file/{$this->bucketName}/{$path}";
    }
}